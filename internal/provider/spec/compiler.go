...
func validateOperationCall(operation catalog.Operation, usage string) error {
	...
	if call.Style != "RPC" && call.Style != "ROA" && call.Style != "google-rest" && call.Style != "azure-rest" && call.Style != "azure-batch-rest" && call.Style != "azure-communication-rest" && call.Style != "azure-synapse-rest" {
