...
| Infrastructure Manager | Deployments, revisions, resource records, previews and change/drift records | Reviewed deployment and preview cleanup; child metadata has no independent delete |
