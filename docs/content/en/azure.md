...
| Event Hubs | Namespaces, event hubs, consumer groups, authorization rules, recovery aliases, schema/application groups and private endpoint connections | Independent native actions and reviewed namespace/event-hub cascades; paired recovery aliases use reviewed unpairing before deletion |
