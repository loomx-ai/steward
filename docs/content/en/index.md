...
<div class="docs-start-links"><a href="./scans.md"><strong>Scan resources</strong><span aria-hidden="true">→</span><span>Choose a scope and inspect scan results</span></a><a href="./topology.md"><strong>Explore relationships</strong><span aria-hidden="true">→</span><span>Inspect dependencies from the network panorama</span></a><a href="./cleanup.md"><strong>Clean up resources</strong><span aria-hidden="true">→</span><span>Review targets and impacts before execution</span></a><a href="./deployment.md"><strong>Deploy the server</strong><span aria-hidden="true">→</span><span>Network access, authentication, and backups</span></a></div>
