...
Steward 是云资源盘点与清理工具。它把云账号中已有的资源整理到统一界面，帮助你确认“有什么、彼此如何关联、清理会影响什么”。目前支持阿里云、AWS 和 Google Cloud（GCP），可自行部署，也可使用受邀开放的 Steward Cloud。
...
| 概念 | 回答的问题 | 例子 |
| --- | --- | --- |
| 云连接 | 用哪个身份访问哪个账号？ | 阿里云、AWS 或 Google Cloud 连接 |
