#!/usr/bin/env python3
"""Reproduce selected official CLI responses (requires PyYAML).
...
SOURCES = {
    "test_notebook.yaml": ("c712c41bae3470b6e5dfc5cfd9cc16b57ffab90bdb19337391ceda3fcfae35bd", [24, 25, 26, 30]),
    "test_spark_job_definition.yaml": ("033079355277b797e330400f307080b8a0664cba0f2d38dfe011038cc082650f", [23, 24, 28]),
}
result = []
for filename, (fingerprint, indices) in SOURCES.items():
    ...
    for index in indices:
        ...
        if request["method"] != "GET" or "api-version=2020-12-01" not in request["uri"]:
