...
func (a *action) MutationSettled(ctx context.Context, request contracts.ActionRequest, result contracts.ActionResult) (contracts.MutationSettlement, error) {
	...
	if a.kind.NativeType == uptimeType || a.kind.NativeType == alertPolicyType || a.kind.NativeType == notificationChannelType || a.kind.NativeType == monitoringGroupType || a.kind.NativeType == monitoringDashboardType {
